...
## Modo autônomo (LNN/LLM Agent)

Para executar em ciclos autônomos:

```bash
cd agent
go run ./hitl -auto -goal "Evoluir pipeline de documentação" -iterations 8
```

Saída de auditoria: `autonomous_cycles.jsonl`.
